export function connectWalletTemplate({
	alertDialogImport,
	avatarImport,
	buttonImport,
	useAccountActionsImport,
}: {
	buttonImport: string;
	alertDialogImport: string;
	avatarImport: string;
	useAccountActionsImport: string;
}) {
  ...
  import { useAccountActions } from "${useAccountActionsImport}";
  import {
    AlertDialog,
    AlertDialogCancel,
    AlertDialogContent,
    ...
    AlertDialogTitle,
    AlertDialogTrigger,
  } from "${alertDialogImport}";
  import { Avatar, AvatarFallback, AvatarImage } from "${avatarImport}";
